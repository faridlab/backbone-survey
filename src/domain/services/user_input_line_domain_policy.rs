//! Domain policy for UserInputLine aggregate
//!
...
/// Domain policy for UserInputLine — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<UserInputLine>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type UserInputLineDomainPolicy = PermitAllPolicy<UserInputLine>;
