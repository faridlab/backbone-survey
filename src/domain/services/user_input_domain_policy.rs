//! Domain policy for UserInput aggregate
//!
...
/// Domain policy for UserInput — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<UserInput>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type UserInputDomainPolicy = PermitAllPolicy<UserInput>;
