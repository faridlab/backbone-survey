//! Domain policy for QuestionAnswer aggregate
//!
...
/// Domain policy for QuestionAnswer — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<QuestionAnswer>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type QuestionAnswerDomainPolicy = PermitAllPolicy<QuestionAnswer>;
