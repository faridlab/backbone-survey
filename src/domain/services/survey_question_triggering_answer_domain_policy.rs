//! Domain policy for SurveyQuestionTriggeringAnswer aggregate
//!
...
/// Domain policy for SurveyQuestionTriggeringAnswer — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<SurveyQuestionTriggeringAnswer>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type SurveyQuestionTriggeringAnswerDomainPolicy = PermitAllPolicy<SurveyQuestionTriggeringAnswer>;
