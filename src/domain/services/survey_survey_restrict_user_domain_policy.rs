//! Domain policy for SurveySurveyRestrictUser aggregate
//!
...
/// Domain policy for SurveySurveyRestrictUser — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<SurveySurveyRestrictUser>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type SurveySurveyRestrictUserDomainPolicy = PermitAllPolicy<SurveySurveyRestrictUser>;
