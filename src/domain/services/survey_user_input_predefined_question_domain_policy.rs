//! Domain policy for SurveyUserInputPredefinedQuestion aggregate
//!
...
/// Domain policy for SurveyUserInputPredefinedQuestion — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<SurveyUserInputPredefinedQuestion>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type SurveyUserInputPredefinedQuestionDomainPolicy = PermitAllPolicy<SurveyUserInputPredefinedQuestion>;
