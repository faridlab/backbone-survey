//! Specifications for Question aggregate
//!
...
// Each predicate implements `Specification<Question>` and can be combined
...
//
// pub struct ActiveQuestionSpec;
// impl Specification<Question> for ActiveQuestionSpec {
//     fn is_satisfied_by(&self, e: &Question) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
