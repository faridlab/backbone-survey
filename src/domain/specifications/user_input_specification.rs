//! Specifications for UserInput aggregate
//!
...
// Each predicate implements `Specification<UserInput>` and can be combined
...
//
// pub struct ActiveUserInputSpec;
// impl Specification<UserInput> for ActiveUserInputSpec {
//     fn is_satisfied_by(&self, e: &UserInput) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
