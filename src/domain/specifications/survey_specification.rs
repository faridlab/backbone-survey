//! Specifications for Survey aggregate
//!
...
// Each predicate implements `Specification<Survey>` and can be combined
...
//
// pub struct ActiveSurveySpec;
// impl Specification<Survey> for ActiveSurveySpec {
//     fn is_satisfied_by(&self, e: &Survey) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
