//! Specifications for QuestionAnswer aggregate
//!
...
// Each predicate implements `Specification<QuestionAnswer>` and can be combined
...
//
// pub struct ActiveQuestionAnswerSpec;
// impl Specification<QuestionAnswer> for ActiveQuestionAnswerSpec {
//     fn is_satisfied_by(&self, e: &QuestionAnswer) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
